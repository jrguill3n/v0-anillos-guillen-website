      ...
      <main className="min-h-screen">
        <section className="py-20">
          <div className="container mx-auto max-w-7xl px-6">
            ...
            <div className="mb-8 p-3 bg-blue-50 border border-blue-200 rounded text-xs text-blue-900">
              <p>Public rings from DB: {validRings.length}</p>
              <p>Slugs: {validRings.slice(0, 10).map(r => r.slug).join(", ") || "none"}</p>
            </div>
